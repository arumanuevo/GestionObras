        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">Crear Nueva Obra</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('obras.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="descripcion" name="descripcion" rows="3" placeholder="Opcional"></textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ubicacion" name="ubicacion" placeholder="Opcional">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="fecha_fin" name="fecha_fin" placeholder="Opcional">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control role-select" name="jefe_proyecto_id" data-role="Jefe de Proyecto">
                                                            ...
                                                            <option value="{{ $usuario->id }}" data-email="{{ $usuario->email }}" data-organization="{{ $usuario->organization ?? 'Sin organización' }}">
                                ...
                                <div class="alert alert-info mt-4">
                                    ...
                                    <ul class="mb-0 pl-3">
                                        ...
                                        <li>Los visualizadores pueden ser asignados después de crear la obra.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function() {
    // Objeto para almacenar los usuarios seleccionados
    var assignedUsers = {};
    ...
    $('.role-select').on('change', function() {
        ...
        Object.keys(assignedUsers).forEach(function(id) {
            if (assignedUsers[id] === roleName && id !== userId) {
                delete assignedUsers[id];
            }
        });
